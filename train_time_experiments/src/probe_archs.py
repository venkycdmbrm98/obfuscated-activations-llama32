"""Probe architectures for classifying transformer residual activations.

The released artifacts use linear probes.  Nonlinear and exploratory probe
classes are retained because the training entry point exposes those options.
"""
